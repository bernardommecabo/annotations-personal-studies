# 📚 Study Notes & Courses Repository

This repository serves as my central knowledge base. It contains my study notes, code challenges, project solutions, and practical exercises from various courses and my Computer Science degree.

The goal is to document my learning journey in **Backend Development**, **Cloud Computing**, and **Computer Science Fundamentals**.

---

## 🏆 Trophies & Competencies (Skills Overview)
...
Here you will find folders organized by specific courses and bootcamps.

### ☁️ CI&T - Backend with Java & AWS
...
> **Study Objective:**
> To deepen my understanding of the Spring Boot ecosystem by applying advanced concepts directly to the [**Personal Finance Manager**](https://github.com/bernardommecabo/personal-finance-manager) project. The focus is on building a robust, production-ready architecture using DTO patterns, Custom Exception Handling, and Secure Authentication.

* **📂 Security Implementation**
    * Implementation of *JWT (JSON Web Tokens)* for stateless authentication.
    * Configuring *Spring Security Filter Chains* for endpoint protection.
    * Role-Based Access Control (RBAC) to manage user permissions.
    * Password encoding strategies using *BCrypt*.
    * **📝 *Notes & Snippets***
